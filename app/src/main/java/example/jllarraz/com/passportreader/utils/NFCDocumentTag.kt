        ...
        return  fromCallable {
            ...
            try {
                ...
                if (passIdChallenge != null) {
                    val pidPassportNFC = PassIdPassportNFC(ps, mrzInfo, passIdChallenge)
                    passIdData = PassIdData()
                    passIdData.sodFile = pidPassportNFC.sodFile
                    passIdData.dg1File = pidPassportNFC.dg1File
                    passIdData.dg14File = pidPassportNFC.dg14File
                    passIdData.dg15File = pidPassportNFC.dg15File
                    passIdData.ccSignatures = pidPassportNFC.ccSignatures
                }
                else {
